...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordflow}{if} ((data[0] \& 128) == 128) \{}
\DoxyCodeLine{  bytes[length] = data[data\_count];}
\DoxyCodeLine{  byte\_count = 1;}
\DoxyCodeLine{\} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{  \textcolor{keywordflow}{while} ((data[data\_count] \& 128) == 128) \{}
\DoxyCodeLine{      bytes[length-\/-\/] = data[data\_count++];}
\DoxyCodeLine{      byte\_count++;}
\DoxyCodeLine{      \textcolor{keywordflow}{if} (byte\_count == 9)}
